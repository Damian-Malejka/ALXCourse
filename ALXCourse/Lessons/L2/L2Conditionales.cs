...
{
    public class L2Conditionales
    {
        public static void Run()
        {
            Console.Write("Enter a number: ");//wprowadz liczbe
            var number = Int32.Parse(Console.ReadLine());

            //CheckIfNumberIsEven(number);

            Console.Write("Enter down limit: ");//wprowadz liczbe
            var limit1 = Int32.Parse(Console.ReadLine());

            Console.Write("Enter upper limit: ");//wprowadz liczbe
        ...
        private static void CheckIfNumberIsEven(int number) //metoda run jest statyczna wiec ta tez musi być
        {
            if (number % 2 == 0)
            {
        ...
        private static void CheckNumberWithinLimits(int number, int limit1, int limit2)
        {
            ...
            {
                Console.WriteLine($"{number} is equal to {limit1} or equal to {limit2} or between {limit1} and {limit2}");
            }
        }
    }
}
